...
public class RegionResourceIntTest {
    ...
    private static final Instant DEFAULT_SAATDAKIKA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SAATDAKIKA = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getSaatdakika()).isEqualTo(DEFAULT_SAATDAKIKA);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].saatdakika").value(hasItem(DEFAULT_SAATDAKIKA.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.saatdakika").value(DEFAULT_SAATDAKIKA.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getSaatdakika()).isEqualTo(UPDATED_SAATDAKIKA);
    }
